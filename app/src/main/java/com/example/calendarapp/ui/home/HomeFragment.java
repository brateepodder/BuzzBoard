...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater,
        ...
        classList.add(new ClassModel("CS2340", LocalTime.parse("8:00 AM", DateTimeFormatter.ofPattern("h:mm a")), LocalTime.parse("9:15 AM", DateTimeFormatter.ofPattern("h:mm a")), new DayOfWeek[]{DayOfWeek.MONDAY, DayOfWeek.WEDNESDAY}, "Pedro"));
        classList.add(new ClassModel("CS3001", LocalTime.parse("09:30 AM", DateTimeFormatter.ofPattern("h:mm a")), LocalTime.parse("10:45 PM", DateTimeFormatter.ofPattern("h:mm a")),new DayOfWeek[]{DayOfWeek.TUESDAY, DayOfWeek.THURSDAY}, "Prof. Johnson"));
